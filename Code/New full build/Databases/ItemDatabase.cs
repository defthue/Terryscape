...
public class ItemDefinition
{
	...
	// Gold value when sold to a shop. 0 means the item is not sellable.
	// These are intentionally conservative — easier to bump up later than to nerf
	// after players have already farmed gold off something overpriced.
...
public static class ItemDatabase
{
	...
	static void Build()
	{
		...
		// Logs — modest values, common drops
		...
		// Trash resources — basically free
		...
		// Gems — uncommon drops, decent value
		Add( Define( ItemId.RoughGem, "Rough Gem", ItemType.Resource, tier: 1, baseSellPrice: 5 ) );
		Add( Define( ItemId.FineGem, "Fine Gem", ItemType.Resource, tier: 3, baseSellPrice: 15 ) );
		Add( Define( ItemId.PristineGem, "Pristine Gem", ItemType.Resource, tier: 5, baseSellPrice: 30 ) );

		// Bars — refined, more valuable than ore
		...
		// Pickaxes — same scale as hatchets
		...
		// Arrows — consumable, low value each (stackable)
		...
		// Heavy armor — tier × 6 for chestplate, less for helm/legs
		...
		// Medium armor — slightly less than heavy
		...
		Add( Define( ItemId.FineRing, "Fine Ring", ItemType.Ring, tier: 3, maxStack: 1, slot: EquipSlot.Ring, skillRequired: SkillType.Smithing, levelRequired: 25, baseSellPrice: 25 ) );
		Add( Define( ItemId.PristineRing, "Pristine Ring", ItemType.Ring, tier: 5, maxStack: 1, slot: EquipSlot.Ring, skillRequired: SkillType.Smithing, levelRequired: 45, baseSellPrice: 50 ) );
		...
		// Gold can't be sold for gold. BaseSellPrice intentionally 0.
